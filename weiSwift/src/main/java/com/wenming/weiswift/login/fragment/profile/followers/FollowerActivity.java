package com.wenming.weiswift.login.fragment.profile.followers;
 ...
 */
public class FollowerActivity extends Activity implements IEndlessRecyclerView {
    ...
    public void pullToRefreshData() {
        ...
        mNext_cursor = "0";
        mFriendshipsAPI.followers(Long.parseLong(AccessTokenKeeper.readAccessToken(this).getUid()), 50, Integer.valueOf(mNext_cursor), false, new RequestListener() {
            @Override
