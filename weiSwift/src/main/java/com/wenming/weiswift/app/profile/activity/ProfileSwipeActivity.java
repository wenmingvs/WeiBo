package com.wenming.weiswift.app.profile.activity;
...
import com.wenming.weiswift.app.mvp.presenter.UserActivityPresent;
import com.wenming.weiswift.app.mvp.presenter.imp.UserActivityPresentImp;
import com.wenming.weiswift.app.mvp.view.UserActivityView;
import com.wenming.weiswift.app.common.base.BaseSwipeActivity;
import com.wenming.weiswift.app.home.timeline.adapter.UserInfoAdapter;
import com.wenming.weiswift.app.home.timeline.adapter.UserPhotoAdapter;
import com.wenming.weiswift.app.home.timeline.weiboitem.TimelineArrowWindow;
import com.wenming.weiswift.app.home.timeline.adapter.WeiboAdapter;
import com.wenming.weiswift.app.profile.UserHeadView;
import com.wenming.weiswift.app.profile.UserInfoFooter;
 ...
 */
public class ProfileSwipeActivity extends BaseSwipeActivity implements UserActivityView {
...
//                    popupWindow.showAtLocation(mRecyclerView, Gravity.CENTER, 0, 0);
    ...
    public void showLoadFooterView(String currentGroup) {
        if (currentGroup.equals(USER_ACTIVITY_USER_STATUS)) {
            RecyclerViewStateUtils.setFooterViewState(ProfileSwipeActivity.this, mRecyclerView, mMyWeiBoAdapter.getItemCount(), LoadingFooter.State.Loading, null);
        } else if (currentGroup.equals(USER_ACTIVITY__USER_PHOTO)) {
            RecyclerViewStateUtils.setFooterViewState(ProfileSwipeActivity.this, mRecyclerView, mImageAdapter.getItemCount(), LoadingFooter.State.Loading, null);
        }
    }
