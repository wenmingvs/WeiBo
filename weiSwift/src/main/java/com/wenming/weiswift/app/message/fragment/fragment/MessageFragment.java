package com.wenming.weiswift.app.message.fragment.fragment;
...
import com.wenming.weiswift.app.message.mention.activity.MentionSwipeActivity;
    ...
    private void setUpListener() {
        ...
        mMention_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, MentionSwipeActivity.class);
        ...
        mComment_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, CommentSwipeActivity.class);
                mContext.startActivity(intent);
            }
        });
