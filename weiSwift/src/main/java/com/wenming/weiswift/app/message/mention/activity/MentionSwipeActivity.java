package com.wenming.weiswift.app.message.mention.activity;
...
import com.wenming.weiswift.app.message.mention.adapter.MentionAdapter;
import com.wenming.weiswift.app.message.mention.widget.GroupPopWindow;
import com.wenming.weiswift.app.message.mention.widget.MentionArrowWindow;
import com.wenming.weiswift.app.mvp.presenter.MentionActivityPresent;
import com.wenming.weiswift.app.mvp.presenter.imp.MentionActivityPresentImp;
import com.wenming.weiswift.app.mvp.view.MentionActivityView;
...
import com.wenming.weiswift.app.message.comment.adapter.CommentAdapter;
 ...
 */
public class MentionSwipeActivity extends BaseSwipeActivity implements MentionActivityView {
...
//                    popupWindow.showAtLocation(mRecyclerView, Gravity.CENTER, 0, 0);
    ...
    public void showLoadFooterView(int currentGroup) {
        if (currentGroup == Constants.GROUP_RETWEET_TYPE_ALL || currentGroup == Constants.GROUP_RETWEET_TYPE_FRIENDS || currentGroup == Constants.GROUP_RETWEET_TYPE_ORIGINWEIBO) {
            RecyclerViewStateUtils.setFooterViewState(MentionSwipeActivity.this, mRecyclerView, mMentionDatas.size(), LoadingFooter.State.Loading, null);
        } else if (currentGroup == Constants.GROUP_RETWEET_TYPE_ALLCOMMENT || currentGroup == Constants.GROUP_RETWEET_TYPE_FRIEDNSCOMMENT) {
            RecyclerViewStateUtils.setFooterViewState(MentionSwipeActivity.this, mRecyclerView, mCommentDatas.size(), LoadingFooter.State.Loading, null);
        }
    }
