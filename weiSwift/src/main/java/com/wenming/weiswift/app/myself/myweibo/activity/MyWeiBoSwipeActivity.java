package com.wenming.weiswift.app.myself.myweibo.activity;
...
import com.wenming.weiswift.app.home.timeline.weiboitem.SeachHeadView;
 ...
 */
public class MyWeiBoSwipeActivity extends BaseSwipeActivity implements MyWeiBoActivityView {
...
//                popupWindow.showAtLocation(mRecyclerView, Gravity.CENTER, 0, 0);
    ...
    public void showLoadFooterView() {
        RecyclerViewStateUtils.setFooterViewState(MyWeiBoSwipeActivity.this, mRecyclerView, mDatas.size(), LoadingFooter.State.Loading, null);
    }
