package com.wenming.weiswift.app.login.post.picselect.activity;
...
import com.wenming.weiswift.app.login.post.picselect.adapter.GirdViewAdapter;
import com.wenming.weiswift.app.login.post.picselect.bean.AlbumFolderInfo;
import com.wenming.weiswift.app.login.post.picselect.bean.ImageInfo;
import com.wenming.weiswift.app.login.post.picselect.popwindow.ImgFolderPopWindow;
import com.wenming.weiswift.app.login.post.picselect.util.ImageScan;
 ...
 */
public class AlbumSwipeActivity extends BaseSwipeActivity implements ImgFolderPopWindow.OnFolderClickListener, GirdViewAdapter.OnImgSelectListener {
    ...
    private void setUpListener() {
        folderLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPopWindow.setOnFolderClickListener(AlbumSwipeActivity.this);
