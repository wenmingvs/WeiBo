package com.wenming.weiswift.app.home.weibo.fragment;
...
import com.wenming.weiswift.app.home.weibo.weiboitem.HomeHeadView;
import com.wenming.weiswift.app.home.weibo.weiboitem.TimelineArrowWindow;
import com.wenming.weiswift.app.home.weibo.widget.GroupPopWindow;
 ...
 */
public class WeiBoFragment extends BaseFragment implements HomeFragmentView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_home_weibo, container, false);
    }
    ...
    private void prepareView() {
        ...
        mTopBar = (LinearLayout) findViewById(R.id.toolbar_home);
        mGroup = (LinearLayout) findViewById(R.id.group);
        mUserNameTextView = (TextView) findViewById(R.id.name);
        mEmptyLayout = (LinearLayout) findViewById(R.id.emptydeault_layout);
        ...
        mToastTv = (TextView) findViewById(R.id.toast_msg);
        mToastBg = (RelativeLayout) findViewById(R.id.toast_bg);
    }
