package com.wenming.weiswift.app.login.post.idea;
...
import com.wenming.weiswift.app.login.post.idea.imagelist.ImgListAdapter;
import com.wenming.weiswift.app.login.post.picselect.activity.AlbumSwipeActivity;
...
public class IdeaSwipeActivity extends BaseSwipeActivity implements ImgListAdapter.OnFooterViewClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mStartAlumbAcitivity == true) {
            Intent intent = new Intent(IdeaSwipeActivity.this, AlbumSwipeActivity.class);
