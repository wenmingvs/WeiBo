package com.wenming.weiswift.app.settings.accouts.activity;
 ...
 */
public class AccoutSwipeActivity extends BaseSwipeActivity implements AccoutActivityView {
    ...
    public void setUpListener() {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AccoutSwipeActivity.this, MainActivity.class);
