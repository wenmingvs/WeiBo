...
public enum OnekeyShareTheme {
	...
	private final cn.sharesdk.onekeyshare.OnekeyShareThemeImpl impl;

	private OnekeyShareTheme(int value, cn.sharesdk.onekeyshare.OnekeyShareThemeImpl impl) {
		this.value = value;
		this.impl = impl;
	}
	...
	public cn.sharesdk.onekeyshare.OnekeyShareThemeImpl getImpl() {
		return impl;
	}
