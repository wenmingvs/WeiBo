...
public abstract class PlatformPageAdapter extends ViewPagerAdapter implements OnClickListener {
	...
	private cn.sharesdk.onekeyshare.themes.classic.PlatformPage page;
	private cn.sharesdk.onekeyshare.themes.classic.IndicatorView vInd;
	...
	public PlatformPageAdapter(cn.sharesdk.onekeyshare.themes.classic.PlatformPage page, ArrayList<Object> cells) {
		this.page = page;
	...
	public void setIndicator(cn.sharesdk.onekeyshare.themes.classic.IndicatorView view) {
		vInd = view;
	}
